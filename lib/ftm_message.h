...
#define	FTM_MSG_TYPE_CCTV_SET_PROPERTIES	12
#define	FTM_MSG_TYPE_SWITCH_CONTROL			13
#define	FTM_MSG_TYPE_CHECK_NEW_SWITCH		14
#define	FTM_MSG_TYPE_FOUND_NEW_SWITCH_IN_DB	15
#define	FTM_MSG_TYPE_REMOVED_SWITCH_IN_DB	16
#define	FTM_MSG_TYPE_CREATE_CCTV			17
#define	FTM_MSG_TYPE_ATTACH_CCTV			18
#define	FTM_MSG_TYPE_DETACH_CCTV			19
#define	FTM_MSG_TYPE_QUIT					20
...
typedef	struct	FTM_MSG_CCTV_SET_PROPERTIES_STRUCT
{
	FTM_MSG			xHead;
	FTM_CHAR		pID[FTM_ID_LEN+1];
	FTM_CCTV_CONFIG	xConfig;
	FTM_UINT32		ulFieldFlags;
}	FTM_MSG_CCTV_SET_PROPERTIES, _PTR_ FTM_MSG_CCTV_SET_PROPERTIES_PTR;
