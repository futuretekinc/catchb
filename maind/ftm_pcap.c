...
)
{
    ...
    INFO("%8s : %d.%d.%d.%d", "SA", ((pIPH->saddr >> 0) & 0xFF), ((pIPH->saddr >> 8) & 0xFF), ((pIPH->saddr >> 16) & 0xFF), ((pIPH->saddr >> 24) & 0xFF));
	INFO("%8s : %d.%d.%d.%d", "DA", ((pIPH->daddr >> 0) & 0xFF), ((pIPH->daddr >> 8) & 0xFF), ((pIPH->daddr >> 16) & 0xFF), ((pIPH->daddr >> 24) & 0xFF));
#endif
