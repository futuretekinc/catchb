...
FTM_RET	FTM_SHELL_CMD_connect(FTM_SHELL_PTR pShell, FTM_INT nArgc, FTM_CHAR_PTR pArgv[], FTM_VOID_PTR pData);
FTM_RET	FTM_SHELL_CMD_client(FTM_SHELL_PTR pShell, FTM_INT nArgc, FTM_CHAR_PTR pArgv[], FTM_VOID_PTR pData);
...
FTM_SHELL_CMD	pCatchBShellCmdList[] = 
{
	{
		.pString	= "client",
		.function	= FTM_SHELL_CMD_client,
		.pShortHelp	= "client settings.",
		.pHelp		= "<cmd>\n"
					  "  client settings.\n"
					  "COMMANDs:\n"
					  "  connect <IP> <PORT>\n"
	...
	{
		.pString	= "connect",
		.function	= FTM_SHELL_CMD_connect,
		.pShortHelp	= "connect settings.",
		.pHelp		= "<cmd>\n"
					  "  connect settings.\n"
					  "COMMANDs:\n"
					  "  connect <IP> <PORT>\n"
